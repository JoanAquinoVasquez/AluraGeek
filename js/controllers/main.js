...
function createcard(nombre, precio, imagen, id) {
  ...
  card.innerHTML = `
    ...
    <div class="producto-precio-borrar">
        <p class="producto-precio">S/. ${precio}.00</p> <!-- Precio del producto -->
        <button class="icono-borrar" data-id="${id}">
            <div class="icono-basurero">
                <img src="https://cdn-icons-png.flaticon.com/512/3143/3143497.png" alt="Eliminar">
            </div>
